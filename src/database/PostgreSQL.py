...
"""
O host pode causar certo problema, pois quando rodamos a apicação e o banco de dados atraves do docker-compose, ambos estão na mesma rede, então o host é o nome do serviço do banco de dados, que no caso é "db", já quando rodamos apenas o banco de dados, o host é "0.0.0.0", pois o banco de dados está rodando na máquina local.
